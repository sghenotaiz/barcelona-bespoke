...
export const translations = {
  en: {
    ...
    services: {
      ...
      expNightlifeSubtitle: "Live the night like a VIP in Barcelona",
      expNightlifeDesc: "VIP tables with magnum bottles, guaranteed skip-the-line access and weekly packs at the best clubs — always at the most convenient prices.",
      expNightlifeBullet1: "Exclusive tables in top clubs",
      expNightlifeBullet2: "Instant access — no queues, ever",
      expNightlifeBullet3: "Multi-night packs = exclusive discounts",
