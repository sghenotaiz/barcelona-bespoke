...
export const translations = {
  en: {
    ...
    services: {
      ...
      expNightlifeTitle: "Nightlife & VIP Club",
      expNightlifeDesc: "VIP tables with magnum bottles, guaranteed skip-the-line access and weekly packs for multiple nights at the best clubs in Barcelona — always at the most convenient prices.",
      expNightlifeBullet1: "VIP tables in top clubs",
      expNightlifeBullet2: "Skip-the-line guaranteed every night",
      expNightlifeBullet3: "Weekly packs = pay less for more nights",
      expPoolTitle: "Pool Parties",
      expPoolDesc: "Exclusive daytime events with sun, music and the best vibes — different parties every day of the week.",
      expPoolBullet1: "Daily events with top DJs",
      expPoolBullet2: "Best pools & beach clubs in the city",
      expRestaurantTitle: "Restaurant Discounts",
      expRestaurantDesc: "Enjoy Barcelona's best restaurants with exclusive discounts and guaranteed table reservations through our network.",
      expRestaurantBullet1: "10-20% off at partner restaurants",
      expRestaurantBullet2: "Guaranteed table reservations",
      expApartmentsTitle: "Apartments & Hotels",
      expApartmentsDesc: "A curated selection of apartments and hotels in Barcelona's best locations, at competitive rates.",
      expApartmentsBullet1: "Central locations near nightlife",
      expApartmentsBullet2: "Apartments and boutique hotels",
      expLimoTitle: "Limousine & Chauffeur",
      expLimoDesc: "Arrive in style with luxury limousines and professional chauffeurs — from hotel to club or airport.",
      expLimoBullet1: "Luxury limo service door-to-door",
      expLimoBullet2: "Airport transfers available",
      expJetskiTitle: "Jet Ski",
      expJetskiDesc: "Ride the Mediterranean waves off Barcelona's coast — adrenaline, sun and unforgettable panoramic views.",
      expJetskiBullet1: "High-adrenaline water experiences",
      expJetskiBullet2: "Stunning coastline views",
      expEventsTitle: "Private Events",
      expEventsDesc: "Tailor-made events for bachelor/bachelorette parties and corporate groups — themed parties, VIP areas and custom experiences.",
  ...
  es: {
    ...
    services: {
      ...
      expNightlifeTitle: "Nightlife & VIP Club",
      expNightlifeDesc: "Mesas VIP con botellas magnum, acceso saltafila garantizado y packs semanales para varias noches en los mejores clubs de Barcelona — siempre a los precios más convenientes.",
      expNightlifeBullet1: "Mesas VIP en los mejores clubs",
      expNightlifeBullet2: "Saltafila garantizado cada noche",
      expNightlifeBullet3: "Packs semanales = paga menos por más noches",
      expPoolTitle: "Pool Parties",
      expPoolDesc: "Eventos exclusivos diurnos con sol, música y las mejores vibras — fiestas diferentes cada día de la semana.",
      expPoolBullet1: "Eventos diarios con los mejores DJs",
      expPoolBullet2: "Las mejores piscinas y beach clubs",
      expRestaurantTitle: "Descuentos Restaurantes",
      expRestaurantDesc: "Disfruta de los mejores restaurantes de Barcelona con descuentos exclusivos y reserva de mesa garantizada.",
      expRestaurantBullet1: "10-20% de descuento en restaurantes",
      expRestaurantBullet2: "Reserva de mesa garantizada",
      expApartmentsTitle: "Apartamentos y Hoteles",
      expApartmentsDesc: "Una selección de apartamentos y hoteles en las mejores zonas de Barcelona, a precios competitivos.",
      expApartmentsBullet1: "Ubicaciones céntricas cerca de la vida nocturna",
      expApartmentsBullet2: "Apartamentos y hoteles boutique",
      expLimoTitle: "Limusina y Chófer",
      expLimoDesc: "Llega con estilo en limusinas de lujo con chóferes profesionales — del hotel al club o al aeropuerto.",
      expLimoBullet1: "Servicio de limusina puerta a puerta",
      expLimoBullet2: "Traslados al aeropuerto disponibles",
      expJetskiTitle: "Moto de Agua",
      expJetskiDesc: "Surca las olas del Mediterráneo frente a Barcelona — adrenalina, sol y vistas panorámicas inolvidables.",
      expJetskiBullet1: "Experiencias acuáticas de alta adrenalina",
      expJetskiBullet2: "Vistas espectaculares de la costa",
      expEventsTitle: "Eventos Privados",
      expEventsDesc: "Eventos a medida para despedidas de soltero/soltera y empresas — fiestas temáticas, áreas VIP y experiencias personalizadas.",
  ...
  fr: {
    ...
    services: {
      ...
      expNightlifeTitle: "Nightlife & VIP Club",
      expNightlifeDesc: "Tables VIP avec bouteilles magnum, accès coupe-file garanti et forfaits hebdomadaires pour plusieurs nuits dans les meilleurs clubs de Barcelone — toujours aux prix les plus avantageux.",
      expNightlifeBullet1: "Tables VIP dans les meilleurs clubs",
      expNightlifeBullet2: "Coupe-file garanti chaque nuit",
      expNightlifeBullet3: "Forfaits hebdo = payez moins pour plus de nuits",
      expPoolTitle: "Pool Parties",
      expPoolDesc: "Événements exclusifs en journée avec soleil, musique et les meilleures vibes — des fêtes différentes chaque jour.",
      expPoolBullet1: "Événements quotidiens avec les meilleurs DJs",
      expPoolBullet2: "Les meilleures piscines et beach clubs",
      expRestaurantTitle: "Réductions Restaurants",
      expRestaurantDesc: "Profitez des meilleurs restaurants de Barcelone avec des réductions exclusives et des réservations de table garanties.",
      expRestaurantBullet1: "10-20% de réduction dans les restaurants",
      expRestaurantBullet2: "Réservation de table garantie",
      expApartmentsTitle: "Appartements & Hôtels",
      expApartmentsDesc: "Une sélection d'appartements et d'hôtels dans les meilleurs quartiers de Barcelone, à des tarifs compétitifs.",
      expApartmentsBullet1: "Emplacements centraux près de la vie nocturne",
      expApartmentsBullet2: "Appartements et hôtels boutique",
      expLimoTitle: "Limousine & Chauffeur",
      expLimoDesc: "Arrivez avec style en limousine de luxe avec chauffeur professionnel — de l'hôtel au club ou à l'aéroport.",
      expLimoBullet1: "Service limousine porte-à-porte",
      expLimoBullet2: "Transferts aéroport disponibles",
      expJetskiTitle: "Jet Ski",
      expJetskiDesc: "Surfez sur les vagues de la Méditerranée au large de Barcelone — adrénaline, soleil et vues panoramiques inoubliables.",
      expJetskiBullet1: "Expériences aquatiques haute adrénaline",
      expJetskiBullet2: "Vues spectaculaires sur la côte",
      expEventsTitle: "Événements Privés",
      expEventsDesc: "Événements sur mesure pour enterrements de vie de garçon/fille et entreprises — soirées à thème, espaces VIP et expériences personnalisées.",
  ...
  it: {
    ...
    services: {
      ...
      expNightlifeTitle: "Nightlife & VIP Club",
      expNightlifeDesc: "Tavoli VIP con bottiglie magnum, accesso saltafila garantito e pack settimanali per più serate nei migliori club di Barcellona — sempre ai prezzi più convenienti.",
      expNightlifeBullet1: "Tavoli VIP nei migliori club",
      expNightlifeBullet2: "Saltafila garantito ogni sera",
      expNightlifeBullet3: "Pack settimanali = paga meno per più serate",
      expPoolTitle: "Pool Party",
      expPoolDesc: "Eventi esclusivi diurni con sole, musica e le migliori vibrazioni — feste diverse ogni giorno della settimana.",
      expPoolBullet1: "Eventi giornalieri con i migliori DJ",
      expPoolBullet2: "Le migliori piscine e beach club",
      expRestaurantTitle: "Sconti Ristoranti",
      expRestaurantDesc: "Goditi i migliori ristoranti di Barcellona con sconti esclusivi e prenotazione del tavolo garantita.",
      expRestaurantBullet1: "10-20% di sconto nei ristoranti partner",
      expRestaurantBullet2: "Prenotazione tavolo garantita",
      expApartmentsTitle: "Appartamenti & Hotel",
      expApartmentsDesc: "Una selezione di appartamenti e hotel nelle zone migliori di Barcellona, a prezzi competitivi.",
      expApartmentsBullet1: "Posizioni centrali vicino alla vita notturna",
      expApartmentsBullet2: "Appartamenti e hotel boutique",
      expLimoTitle: "Limousine & Autista",
      expLimoDesc: "Arriva con stile in limousine di lusso con autista professionista — dall'hotel al club o all'aeroporto.",
      expLimoBullet1: "Servizio limousine porta a porta",
      ...
      expJetskiBullet1: "Esperienze acquatiche ad alta adrenalina",
      expJetskiBullet2: "Viste spettacolari sulla costa",
      expEventsTitle: "Eventi Privati",
      expEventsDesc: "Eventi su misura per addii al celibato/nubilato e aziende — feste a tema, aree VIP ed esperienze personalizzate.",
