...
export const translations = {
  en: {
    ...
    hero: {
      ...
      skipLineDesc1: "No more hours of queuing outside clubs risking not getting in",
      skipLineDesc2: "Immediate access with no surprises",
    ...
    services: {
      ...
      expTattooSubtitle: "Ink your Barcelona memory",
      ...
      expTattooBullet2: "Choose what you want, we book your session",
      ...
      expDinnerShowBullet1: "Live performances & entertainment",
      expDinnerShowBullet2: "Gourmet multi-course menus",
      expDinnerShowBullet3: "Bottles & drinks in the after-dinner with DJ set",
      expLimoTitle: "Private Transport",
      expLimoSubtitle: "Move around in comfort",
      expLimoDesc: "Luxury limousines with professional chauffeurs — from hotel to club door or airport. Suitable for large or small groups seeking comfort, professionalism and safety.",
    ...
    experiences: {
      ...
      event1Stats: "Sold out • Legendary night",
      event2Title: "Tyga @ Opium",
      event2Date: "July 20, 2025",
      ...
      event4Title: "Erasmus Party @ Bling Bling",
      event4Date: "Every Wednesday",
      event4Stats: "18-23 years • Commercial reggaeton night",
      event5Title: "Bob Sinclair @ Opium",
      event5Date: "July 4, 2024",
      event5Stats: "Iconic night by one of Europe's most famous DJs",
      event6Title: "Hugel @ Ku BCN",
      event6Date: "April 4, 2024",
      event6Stats: "Wild latin house on Ku's Sundays",
      event7Title: "Sunset Rooftop Session",
      event7Date: "Summer 2024",
      event7Stats: "Live DJ • Panoramic views",
      event8Title: "Underground Techno Night",
      event8Date: "Monthly Event",
      event8Stats: "International DJs • 400+ people",
      event9Title: "Latin Carnival Party",
      event9Date: "Feb 2025",
      event9Stats: "Themed costumes • 3 floors",
      event10Title: "Exclusive Yacht Party",
      event10Date: "Spring 2025",
      event10Stats: "50 guests • Open bar",
      review1Name: "Marco B.",
      review1City: "Milano",
    ...
    workWithUs: {
      ...
      careersDesc: "We're always looking for passionate, willing individuals who want to share their enthusiasm to create unforgettable experiences. If you are that person, apply here!",
      role1Title: "VIP Table Organizer",
      role1Desc: "Curate nightlife experiences, manage club partnerships and make sure every client wants to call you back every day.",
      role2Title: "Group Host / Escort",
      role2Desc: "Do you think you can manage large groups and their relationship with clubs? We are looking for hosts for our groups, apply if you feel up to it!",
      ...
      partnersDesc: "We collaborate with Barcelona's finest venues, restaurants, and entertainment providers. Join our exclusive network and gain access to a large client base of travelers.",
      partner1: "Clubs and lounges looking for clientele (VIP tables and more)",
      partner2: "Yacht charters and transport providers",
      partner3: "Restaurants and take-aways, as well as bars for pre-party events",
      partner4: "Wellness, sports, tattoo studios and exclusive activity providers",
    ...
    team: {
      ...
      simoneBio: "ND Promoter since 2020, after spending the entire year in Barcelona in 2021, he has remained a key figure in the NightDreams team and a reference point for new promoters. He also has experience as a promoter in Madrid and Marbella, and is now responsible for the website as well as being present in summer.",
      ...
      martinaBio: "Martina is co-founder of Nightdreams and responsible for operational development and strategic relationships with clients, partners, and venues. She coordinates the promoter team, oversees VIP reservations, and manages the organization of offered experiences, ensuring professionalism, reliability, and a highly personalized service. Thanks to her direct experience in the industry and a strong network in Barcelona's nightlife, she is the operational point of reference for clients and collaborations.",
      ...
      alessiaBio: "Alessia did her first season as a promoter in the summer of 2025: while on Erasmus in Barcelona, she continued during the summer season, becoming part of the NightDreams family.",
      alessioRole: "Promoter ND",
      alessioBio: "Alessio, with over 10 years in Barcelona's event scene. A 360° promoter, he brings experience, availability, and passion at your service 365 days a year. If you're in the city center, on the Rambla, at Boqueria, or in Plaza Catalunya, Alessio is there to welcome you.",
      partnersTitle: "Our",
    ...
    testimonials: {
      ...
      formLabel: "now it's your turn",
      formTitle: "Share Your",
      formTitleAccent: "Moments",
      formSuccess: "Thank you — your submission has been sent!",
      formName: "Name",
      formNamePlaceholder: "Your name",
      formEmail: "Email",
      formEmailPlaceholder: "your@email.com",
      formFile: "Select Photo",
      formFilePlaceholder: "Choose a photo…",
      formType: "Type",
      formTypeReview: "Review",
      formTypePhoto: "Our Photos",
      formComment: "Comment",
    ...
    booking: {
      ...
      description: "Select your dates, group size, and desired activities — we'll send you a personalised proposal by email or WhatsApp.",
      fullName: "Full Name",
      ...
      howDidYouFindPlaceholder: "Select an option...",
      sourceInstagram: "Instagram",
      sourceTiktok: "TikTok",
      sourceGoogle: "Google",
      sourceFriends: "Friends",
      sourcePromoter: "Promoter",
      sourceOther: "Other",
  ...
  es: {
    ...
    hero: {
      ...
      vipTrust: "VIPs confían en nosotros cada año",
      skipLine: "TICKETS SIN COLA",
      skipLineDesc1: "Se acabaron las horas de cola frente a los clubs arriesgándote a no entrar",
      skipLineDesc2: "Acceso inmediato sin sorpresas",
    ...
    services: {
      ...
      expPoolDesc: "Días de sol, agua cristalina y los mejores DJs — fiestas diferentes cada día de la semana, del afrohouse al hip-hop, reggaeton — ¡vive tus tardes a tope de diversión!",
    ...
    experiences: {
      ...
      skipLineExamplesTitle: "EJEMPLOS SALTAFILA",
      reviewsColumnTitle: "RESEÑAS CLIENTES",
      event1Title: "Marco Carola @ Ku BCN",
      event1Date: "30 de Diciembre 2025",
      event1Stats: "Sold out • Noche legendaria",
      event2Title: "Tyga @ Opium",
      event2Date: "20 de Julio 2025",
      event2Stats: "Sold out • Show épico",
      event3Title: "Sfera Ebbasta @ Ku BCN",
      event3Date: "25 de Julio 2025",
      event3Stats: "El king del trap italiano en un show inolvidable",
      event4Title: "Erasmus Party @ Bling Bling",
      event4Date: "Cada miércoles",
      event4Stats: "18-23 años • Noche de reggaeton comercial",
      event5Title: "Bob Sinclair @ Opium",
      event5Date: "4 Julio 2024",
      event5Stats: "Noche icónica de uno de los DJs más famosos de Europa",
      event6Title: "Hugel @ Ku BCN",
      event6Date: "4 Abril 2024",
      event6Stats: "Latin house desenfrenada en los domingos del Ku",
      event7Title: "Sesión Rooftop al Atardecer",
      event7Date: "Verano 2024",
      event7Stats: "DJ en vivo • Vistas panorámicas",
      event8Title: "Noche Techno Underground",
      event8Date: "Evento mensual",
      event8Stats: "DJs internacionales • 400+ personas",
      event9Title: "Fiesta Carnaval Latino",
      event9Date: "Feb 2025",
      event9Stats: "Disfraces temáticos • 3 pisos",
      event10Title: "Fiesta Exclusiva en Yate",
      event10Date: "Primavera 2025",
      event10Stats: "50 invitados • Barra libre",
      review1Name: "Marco B.",
      review1City: "Milán",
      ...
      cardCta: "Reservar",
      finalCtaTitle: "¿ESTÁS LISTO PARA UNIRTE A NOSOTROS?",
    ...
    team: {
      ...
      simoneBio: "Promotor ND desde 2020, después de pasar todo el año en Barcelona en 2021, se ha mantenido como una figura fundamental en el equipo NightDreams y referencia para los nuevos promotores. También tiene experiencia como promotor en Madrid y Marbella, ahora es responsable del sitio web además de estar presente en verano.",
      thomasRole: "Fundador NightDreams",
      thomasBio: "Primeras experiencias como promotor desde los 18 años, Thomàs es uno de los líderes fundadores de la agencia NightDreams. Desde hace más de diez años se ocupa del entretenimiento y las vacaciones de miles de clientes que eligen Barcelona para divertirse. Lo encontrarás todos los días, todo el año en la Barceloneta para recibirte.",
      martinaRole: "Fundadora NightDreams",
      martinaBio: "Martina es cofundadora de Nightdreams y responsable del desarrollo operativo y de las relaciones estratégicas con clientes, socios y locales. Coordina el equipo de promotores, supervisa las reservas VIP y gestiona la organización de las experiencias ofrecidas, asegurando profesionalidad, fiabilidad y un servicio altamente personalizado. Gracias a su experiencia directa en el sector y a una sólida red en la vida nocturna de Barcelona, representa el punto de referencia operativo para clientes y colaboraciones.",
      samuelRole: "Promoter ND",
      samuelBio: "Samu, 24 años, es promotor de la agencia NightDreams desde el verano de 2025. Su objetivo es sencillo: hacer que cada cliente viva una noche inolvidable, con profesionalidad, atención al detalle y un toque personal que marca la diferencia.",
      gialloRole: "Promoter ND",
      gialloBio: "Marco, promoter de NightDreams desde el verano de 2025, tras una carrera detrás de las barras más exclusivas, decidió llevar el arte de la hospitalidad napolitana al corazón de Barcelona. No solo vende entradas: cuida tu noche hasta el más mínimo detalle. Ya sea que busques la mejor mesa en el reservado o el acceso más rápido a las discotecas, él es tu hombre. Habla tu idioma, entiende tus gustos y sabe exactamente dónde late el ritmo correcto cada noche. ¿Su lema? 'Tú pon las ganas de divertirte, del resto me encargo yo.'",
      alessiaRole: "Promoter ND",
      alessiaBio: "Alessia hizo su primera temporada como promotora en el verano de 2025: mientras estaba de Erasmus en Barcelona, continuó durante la temporada de verano, formando parte de la familia NightDreams.",
      alessioRole: "Promoter ND",
      alessioBio: "Alessio, con más de 10 años en el mundo de los eventos en Barcelona. Promoter a 360°, tiene experiencia, disponibilidad y pasión a vuestro servicio los 365 días del año. Si estás en el centro, en la Rambla, en la Boqueria, en Plaza Catalunya, Alessio está ahí para recibirte.",
    ...
    testimonials: {
      ...
      formLabel: "ahora te toca a ti",
      formTitle: "Comparte Tus",
      formTitleAccent: "Momentos",
      formSuccess: "¡Gracias — tu envío ha sido enviado!",
      formName: "Nombre",
      formNamePlaceholder: "Tu nombre",
      formEmail: "Correo",
      formEmailPlaceholder: "tu@email.com",
      formFile: "Seleccionar Foto",
      formFilePlaceholder: "Elige una foto…",
      formType: "Tipo",
      formTypeReview: "Reseña",
      formTypePhoto: "Nuestras Fotos",
    ...
    booking: {
      ...
      howDidYouFind: "¿Cómo nos conociste?",
      howDidYouFindPlaceholder: "Selecciona una opción...",
      sourceInstagram: "Instagram",
      sourceTiktok: "TikTok",
      sourceGoogle: "Google",
      sourceFriends: "Amigos",
      sourcePromoter: "Promoter",
      sourceOther: "Otro",
      ...
      successMessage: "Tu solicitud ha sido enviada. Nuestro equipo te contactará en breve con una propuesta personalizada.",
    },
    becomePartner: {
  ...
  fr: {
    ...
    hero: {
      ...
      skipLineDesc1: "Fini les heures de queue devant les clubs au risque de ne pas entrer",
      skipLineDesc2: "Accès immédiat sans surprises",
    ...
    services: {
      ...
      expPoolDesc: "Journées ensoleillées, eau cristalline et les meilleurs DJs — des fêtes différentes chaque jour, de l'afrohouse au hip-hop, reggaeton — vivez vos après-midi sous le signe du fun !",
      ...
      expRestaurantDesc: "Réductions exclusives de 10-20% dans les meilleurs restaurants avec réservation de table garantie. Dites-nous vos préférences, on s'occupe de tout.",
      expRestaurantBullet1: "10-20% de réduction chez nos partenaires",
      expRestaurantBullet2: "Réservation de table garantie",
      expTattooTitle: "Studio de Tatouage",
      ...
      expDinnerShowDesc: "Expériences gastronomiques exclusives avec divertissement en direct — cabaret, musique et cuisine gourmet en une soirée inoubliable.",
      expDinnerShowBullet1: "Spectacles en direct et divertissement",
      expDinnerShowBullet2: "Menus gastronomiques multi-plats",
      expDinnerShowBullet3: "Bouteilles et boissons en after-dinner avec DJ set",
      expLimoTitle: "Transport Privé",
      expLimoSubtitle: "Déplacez-vous en tout confort",
      expLimoDesc: "Limousines de luxe avec chauffeurs professionnels — de l'hôtel à l'entrée du club ou à l'aéroport. Adapté aux grands ou petits groupes recherchant confort, professionnalisme et sécurité.",
    ...
    experiences: {
      ...
      event1Stats: "Sold out • Soirée légendaire",
      event2Title: "Tyga @ Opium",
      event2Date: "20 Juillet 2025",
      event2Stats: "Sold out • Show épique",
      event3Title: "Sfera Ebbasta @ Ku BCN",
      event3Date: "25 Juillet 2025",
      event3Stats: "Le king de la trap italienne dans un show inoubliable",
      event4Title: "Erasmus Party @ Bling Bling",
      event4Date: "Chaque mercredi",
      event4Stats: "18-23 ans • Soirée reggaeton commerciale",
      event5Title: "Bob Sinclair @ Opium",
      event5Date: "4 Juillet 2024",
      event5Stats: "Soirée iconique d'un des DJs les plus célèbres d'Europe",
      event6Title: "Hugel @ Ku BCN",
      event6Date: "4 Avril 2024",
      event6Stats: "Latin house déchaînée les dimanches du Ku",
      event7Title: "Session Rooftop au Coucher du Soleil",
      event7Date: "Été 2024",
      event7Stats: "DJ live • Vues panoramiques",
      event8Title: "Nuit Techno Underground",
      event8Date: "Événement mensuel",
      event8Stats: "DJs internationaux • 400+ personnes",
      event9Title: "Fête Carnaval Latino",
      event9Date: "Fév 2025",
      event9Stats: "Costumes à thème • 3 étages",
      event10Title: "Fête Exclusive sur Yacht",
      event10Date: "Printemps 2025",
      event10Stats: "50 invités • Open bar",
      review1Name: "Marco B.",
      review1City: "Milan",
      ...
      cardCta: "Réserver",
      finalCtaTitle: "ÊTES-VOUS PRÊT À NOUS REJOINDRE ?",
      finalCtaButton: "Contactez-nous",
      videoLabel: "Highlights of our events",
    ...
    team: {
      ...
      gialloBio: "Marco, promoteur NightDreams depuis l'été 2025, après une carrière derrière les bars les plus exclusifs, a décidé d'apporter l'art de l'hospitalité napolitaine au cœur de Barcelone. Il ne vend pas seulement des entrées : il prend soin de votre soirée dans les moindres détails. Que vous cherchiez la meilleure table en VIP ou l'accès le plus rapide aux discothèques, c'est votre homme. Il parle votre langue, comprend vos goûts et sait exactement où bat le bon rythme chaque soir. Sa devise ? 'Vous apportez l'envie de vous amuser, je m'occupe du reste.'",
      alessiaRole: "Promotrice ND",
      alessiaBio: "Alessia a fait sa première saison en tant que promotrice à l'été 2025 : pendant son Erasmus à Barcelone, elle a continué pendant la saison estivale, intégrant la famille NightDreams.",
      alessioRole: "Promoteur ND",
      alessioBio: "Alessio, plus de 10 ans dans le monde des événements à Barcelone. Promoteur à 360°, il met son expérience, sa disponibilité et sa passion à votre service 365 jours par an. Si vous êtes dans le centre, sur la Rambla, à la Boqueria, à Plaza Catalunya, Alessio est là pour vous accueillir.",
      partnersTitle: "Nos",
    ...
    testimonials: {
      ...
      formFile: "Sélectionner Photo",
      formFilePlaceholder: "Choisir une photo…",
      formType: "Type",
      formTypeReview: "Avis",
      formTypePhoto: "Nos Photos",
    ...
    booking: {
      ...
      howDidYouFind: "Comment nous avez-vous connu ?",
      howDidYouFindPlaceholder: "Sélectionnez une option...",
      sourceInstagram: "Instagram",
      sourceTiktok: "TikTok",
      sourceGoogle: "Google",
      sourceFriends: "Amis",
      sourcePromoter: "Promoteur",
      sourceOther: "Autre",
  ...
  it: {
    ...
    hero: {
      ...
      skipLineDesc1: "Niente file di ore davanti ai club rischiando di non entrare",
      skipLineDesc2: "Accesso immediato senza sorprese",
    ...
    about: {
      ...
      paragraph2:
        "La nostra forza? Onestà assoluta e presenza 365 giorni l'anno. Consigliamo solo i servizi migliori, in base ovviamente alle preferenze e esigenze del cliente, creando legami autentici: i nostri clienti diventano amici e famiglia NightDreams.",
      paragraph3:
    ...
    services: {
      ...
      expVipTablesTitle: "Tavolo VIP",
      expVipTablesSubtitle: "Per chi vuole il massimo",
      expVipTablesDesc: "Affida a noi la tua prenotazione tavolo VIP, ti garantiamo il miglior prezzo/posizione, ti forniremo servizio H24 e accoglienza al di fuori della discoteca accompagnandoti all'ingresso.",
      ...
      expTattooTitle: "Studio Tatuaggi",
      expTattooSubtitle: "Tatuati il ricordo di Barcellona",
      expTattooDesc: "Studi di tatuaggi partner con i migliori artisti — portati a casa un pezzo unico per ricordare la tua esperienza a Barcellona.",
      expTattooBullet1: "Artisti professionisti e studi premium",
      expTattooBullet2: "Scegli ciò che vuoi, ti prenotiamo la seduta",
      expTattooBullet3: "Pulizia e sicurezza garantita, al miglior prezzo",
      expDinnerShowTitle: "Cene Spettacolo",
      expDinnerShowSubtitle: "Cena con un tocco spettacolare",
      expDinnerShowDesc: "Esperienze gastronomiche esclusive con intrattenimento dal vivo — cabaret, musica e cucina gourmet in una serata indimenticabile.",
      expDinnerShowBullet1: "Spettacoli dal vivo e intrattenimento",
      expDinnerShowBullet2: "Menu gourmet multi-portata",
      expDinnerShowBullet3: "Bottiglie e drink nel post-cena con dj set",
      expLimoTitle: "Trasporti Privati",
      expLimoSubtitle: "Muoviti con comodità",
      expLimoDesc: "Limousine di lusso con autisti professionisti — dall'hotel alla porta del club o all'aeroporto. Adatto per gruppi grandi o piccoli che cercano comodità, professionalità e sicurezza.",
    ...
    experiences: {
      ...
      skipLineExamplesTitle: "ESEMPI SALTAFILA",
      reviewsColumnTitle: "RECENSIONI CLIENTI",
      event1Title: "Marco Carola @ Ku BCN",
      event1Date: "30 Dicembre 2025",
      event1Stats: "Sold out • Serata leggendaria",
      event2Title: "Tyga @ Opium",
      event2Date: "20 Luglio 2025",
      ...
      event4Title: "Erasmus Party @ Bling Bling",
      event4Date: "Ogni mercoledì",
      event4Stats: "Serata 18-23 anni commerciale reggaeton",
      event5Title: "Bob Sinclair @ Opium",
      event5Date: "4 Luglio 2024",
      event5Stats: "Serata iconica di uno dei DJ più famosi d'Europa",
      event6Title: "Hugel @ Ku BCN",
      event6Date: "4 Aprile 2024",
      event6Stats: "Latin house sfrenata nelle domeniche del Ku",
      event7Title: "Sessione Rooftop al Tramonto",
      event7Date: "Estate 2024",
      event7Stats: "DJ dal vivo • Vista panoramica",
      event8Title: "Notte Techno Underground",
      event8Date: "Evento mensile",
      event8Stats: "DJ internazionali • 400+ persone",
      event9Title: "Festa Carnevale Latino",
      event9Date: "Feb 2025",
      event9Stats: "Costumi a tema • 3 piani",
      event10Title: "Festa Esclusiva in Yacht",
      event10Date: "Primavera 2025",
      event10Stats: "50 ospiti • Open bar",
      review1Name: "Marco B.",
      review1City: "Milano",
    ...
    workWithUs: {
      ...
      careersDesc: "Cerchiamo persone appassionate, volenterose, che hanno voglia di trasmettere il proprio entusiasmo per creare esperienze indimenticabili. Se sei quella persona, candidati qui!",
      role1Title: "Organizzatore Tavoli VIP",
      role1Desc: "Cura esperienze notturne, gestisci partnership con club e fa si che ogni cliente abbia voglia di richiamarti ogni giorno.",
      role2Title: "Accompagnatore",
      role2Desc: "Credi di saper gestire gruppi grandi e il loro rapporto con le discoteche? Cerchiamo accompagnatori per i nostri gruppi, candidati se ti senti all'altezza!",
      ...
      partnersDesc: "Collaboriamo con i migliori locali, ristoranti e fornitori di intrattenimento di Barcellona. Unisciti alla nostra rete esclusiva e accedi a una clientela numerosa di viaggiatori.",
      partner1: "Club e lounge in cerca di clientela (Tavoli VIP e non)",
      partner2: "Charter di yacht e fornitori di trasporto ",
      partner3: "Ristoranti e take away, oltre a bar per organizzare pre-serata.",
      partner4: "Fornitori di benessere, sport, studi di tatuaggi e attività esclusive",
    ...
    team: {
      ...
      simoneRole: "Promoter ND + Online manager",
      simoneBio: "Promoter ND dal 2020, dopo aver trascorso tutto l'anno a Barcellona nel 2021, a partire dagli anni successivi è rimasto una figura fondamentale nel team NightDreams e di riferimento per i nuovi promoters. Ha esperienza come promoter anche a Madrid e Marbella, adesso è responsabile del sito web oltre ad essere presente in estate.",
      thomasRole: "Founder NightDreams",
      thomasBio: "Prime esperienze da promoter da quando aveva 18 anni, Thomàs è uno dei capi fondatori dell'agenzia NightDreams. Da oltre dieci anni si occupa del divertimento e delle vacanze di migliaia di clienti che scelgono Barcellona per divertirsi. Lo trovate tutti i giorni tutto l'anno in Barceloneta ad accogliervi.",
      martinaRole: "Founder NightDreams",
      martinaBio: "Martina è co-fondatrice di Nightdreams e responsabile dello sviluppo operativo e delle relazioni strategiche con clienti, partner e locali. Coordina il team promoter, supervisiona le prenotazioni VIP e gestisce l'organizzazione delle esperienze offerte, assicurando professionalità, affidabilità e un servizio altamente personalizzato. Grazie alla sua esperienza diretta nel settore e a un forte network nel nightlife di Barcellona, rappresenta il punto di riferimento operativo per clienti e collaborazioni.",
      samuelRole: "Promoter ND",
      ...
      alessioRole: "Promoter ND",
      alessioBio: "Alessio, da oltre 10 anni nel mondo degli eventi a Barcellona. Promoter a 360°, ha esperienza, disponibilità e passione a vostro servizio 365 giorni l'anno. Se sei in centro, in Rambla, in Boqueria, in Plaza Catalunya, Alessio è lì ad accogliervi.",
    ...
    testimonials: {
      ...
      formLabel: "ora tocca a te",
      formTitle: "Condividi i Tuoi",
      formTitleAccent: "Momenti",
      formSuccess: "Grazie — il tuo invio è stato trasmesso!",
      formName: "Nome",
      formNamePlaceholder: "Il tuo nome",
      formEmail: "Email",
      formEmailPlaceholder: "tua@email.com",
      formFile: "Seleziona Foto",
      formFilePlaceholder: "Scegli una foto…",
      formType: "Tipologia",
      formTypeReview: "Recensione",
      formTypePhoto: "Le Nostre Foto",
    ...
    booking: {
      ...
      departureDate: "Data di Ripartenza",
      ...
      howDidYouFind: "Come ci hai conosciuto?",
      howDidYouFindPlaceholder: "Seleziona un'opzione...",
      sourceInstagram: "Instagram",
      sourceTiktok: "TikTok",
      sourceGoogle: "Google",
      sourceFriends: "Amici",
      ...
      submitEmail: "Invia Email",
      submitWhatsApp: "Invia via WhatsApp",
      successTitle: "Grazie!",
      successMessage: "La tua richiesta è stata inviata. Il nostro team ti contatterà a breve con una proposta personalizzata.",
    },
    becomePartner: {
