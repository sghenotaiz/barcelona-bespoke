...
export const translations = {
  en: {
    ...
    services: {
      ...
      expVipTablesBullet2: "Multi-night packs = exclusive discounts",
      expVipTablesBullet3: "Best price guaranteed",
      expSkipLineTitle: "Skip The Line",
      expSkipLineSubtitle: "No more waiting — ever",
      expSkipLineDesc: "Skip hours of queuing to enjoy your night. Our promoters wait OUTSIDE the club, ready to welcome you and escort you to VIP entrance. Outfit check included to guarantee access. Multi-day tickets = real savings!",
      expSkipLineBullet1: "Skip hours of queue",
      expSkipLineBullet2: "Promoters waiting outside",
      expSkipLineBullet3: "Outfit check guaranteed",
      expSkipLineBullet4: "Multi-day = better prices",
  ...
  es: {
    ...
    services: {
      ...
      expVipTablesBullet2: "Packs multi-noche = descuentos exclusivos",
      expVipTablesBullet3: "Mejor precio garantizado",
      expSkipLineTitle: "Skip Line Ticket",
      expSkipLineSubtitle: "Sin más esperas — nunca",
      expSkipLineDesc: "Sáltate horas de cola para disfrutar tu noche. Nuestros promotores te esperan FUERA del club, listos para recibirte y acompañarte a la entrada VIP. Control de outfit incluido para garantizar el acceso. Tickets multi-día = ¡ahorro real!",
      expSkipLineBullet1: "Sáltate horas de cola",
      expSkipLineBullet2: "Promotores esperándote fuera",
      expSkipLineBullet3: "Control de outfit garantizado",
      expSkipLineBullet4: "Multi-día = mejores precios",
      expPoolTitle: "Pool Parties",
  ...
  fr: {
    ...
    services: {
      ...
      expVipTablesBullet2: "Packs multi-nuits = réductions exclusives",
      expVipTablesBullet3: "Meilleur prix garanti",
      expSkipLineTitle: "Skip Line Ticket",
      expSkipLineSubtitle: "Plus jamais de file d'attente",
      expSkipLineDesc: "Évitez des heures de queue pour profiter de votre soirée. Nos promoteurs vous attendent DEVANT le club, prêts à vous accueillir et vous escorter à l'entrée VIP. Contrôle de tenue inclus pour garantir l'accès. Tickets multi-jours = vraies économies !",
      expSkipLineBullet1: "Évitez des heures de queue",
      expSkipLineBullet2: "Promoteurs vous attendant dehors",
      expSkipLineBullet3: "Contrôle de tenue garanti",
      expSkipLineBullet4: "Multi-jours = meilleurs prix",
      expPoolTitle: "Pool Parties",
  ...
  it: {
    ...
    about: {
      ...
      paragraph3:
        "Che altro dire? Ti aspettiamo in questa meravigliosa città! Contattaci ora per un preventivo personalizzato, oppure vieni a trovarci ogni giorno dalle 23:30 in Barceloneta, proprio al di fuori delle porte dei club. A presto!",
      stat1Num: "30+",
    ...
    services: {
      ...
      expVipTablesBullet2: "Pack multi-serata = sconti esclusivi",
      expVipTablesBullet3: "Miglior prezzo garantito",
      expSkipLineTitle: "Skip Line Ticket",
      expSkipLineSubtitle: "Mai più in coda",
      expSkipLineDesc: "Saltare ore di fila è fondamentale per goderti la serata. I nostri promoter ti aspettano FUORI dalla discoteca, pronti ad accoglierti e accompagnarti all'ingresso VIP. Controllo outfit garantito per assicurarti l'accesso senza problemi. Tickets multi-giorno = risparmio economico!",
      expSkipLineBullet1: "Salta ore di coda",
      expSkipLineBullet2: "Promoter ti aspettano fuori",
      expSkipLineBullet3: "Controllo outfit garantito",
      expSkipLineBullet4: "Multi-giorno = prezzi migliori",
      ...
      expApartmentsSubtitle: "Sistemazioni premium vista mare",
