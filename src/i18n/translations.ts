...
export const translations = {
  ...
  es: {
    ...
    services: {
      ...
      expNightlifeTitle: "Nightlife Experience",
      expNightlifeSubtitle: "Vive la noche como VIP en Barcelona",
      expNightlifeDesc: "Mesas VIP con botellas magnum, acceso saltafila garantizado y packs semanales en los mejores clubs — siempre a los precios más convenientes.",
      expNightlifeBullet1: "Mesas exclusivas en los mejores clubs",
      expNightlifeBullet2: "Acceso inmediato — sin colas, nunca",
      expNightlifeBullet3: "Packs multi-noche = descuentos exclusivos",
      expPoolTitle: "Pool Parties",
