...
export const translations = {
  en: {
    ...
    services: {
      ...
      vipBannerSubtitle: "at THE BEST PRICES!",
      ...
      card1Desc: "Magnum bottles, sparklers & exclusive VIP booths in Barcelona's top clubs. The real experience starts here.",
      card2Title: "VIP Entries + Skip-the-Line",
      card2Desc: "Walk straight past the queue into the city's most exclusive venues. No waiting. Pure VIP.",
      card3Title: "More Days Packs / Weekly Pack",
      card3Desc: "Save more by booking events over several days instead of single nights. Our multi-day and weekly packs give you access to multiple parties at a much better price than booking each night separately.",
      card4Title: "Pool Parties",
      card4Desc: "Luxury Barcelona beach club parties, poolside vibes under the Mediterranean sun. Daytime magic.",
      card5Title: "Restaurant Discounts",
      card5Desc: "Exclusive deals at Barcelona's finest restaurants — gourmet paella, premium steak, and Michelin-level cuisine.",
      card6Title: "Apartments & Hotels",
      card6Desc: "Hand-picked luxury apartments and 5-star hotel suites with stunning Barcelona skyline views.",
      card7Title: "Limousine & Chauffeur",
      card7Desc: "Arrive in style. Black luxury limousines with professional chauffeurs — from hotel to club door.",
      card8Title: "Jet Ski",
      card8Desc: "Ride the waves off Barcelona's coast on premium jet skis. Adrenaline, sun & Mediterranean views combined.",
      card9Title: "Private & Themed Events",
  ...
  it: {
    ...
    services: {
      ...
      card1Desc: "Bottiglie Magnum, sparkler e palchi VIP esclusivi nei migliori club di Barcellona. La vera esperienza inizia qui.",
      card2Title: "Ingressi VIP + Salta-Coda",
      card2Desc: "Passa direttamente davanti alla coda nei locali più esclusivi della città. Nessuna attesa. Puro VIP.",
      card3Title: "Pack Più Giorni / Pack Settimanale",
      card3Desc: "Risparmia prenotando eventi su più giorni invece di singole serate. I nostri pack multi-giorno e settimanali ti danno accesso a più feste a un prezzo molto migliore.",
      card4Title: "Pool Party",
      card4Desc: "Feste di lusso nei beach club di Barcellona, vibrazioni a bordo piscina sotto il sole mediterraneo. Magia diurna.",
      card5Title: "Sconti Ristoranti",
      card5Desc: "Offerte esclusive nei migliori ristoranti di Barcellona — paella gourmet, carne premium e cucina stellata.",
      card6Title: "Appartamenti & Hotel",
      card6Desc: "Appartamenti di lusso selezionati e suite 5 stelle con viste mozzafiato sullo skyline di Barcellona.",
      card7Title: "Limousine & Autista",
      card7Desc: "Arriva con stile. Limousine nere di lusso con autisti professionisti — dall'hotel alla porta del club.",
      card8Title: "Moto d'Acqua",
      card8Desc: "Cavalca le onde al largo di Barcellona su moto d'acqua premium. Adrenalina, sole e panorami mediterranei.",
      card9Title: "Eventi Privati & a Tema",
      card9Desc: "Organizziamo eventi privati su misura per addii al celibato e aziende: feste a tema, aree VIP ed esperienze personalizzate per il tuo gruppo.",
      card10Title: "& molto altro..",
      card10Desc: "Biglietti, prenotazioni, transfer privati, assistenza shopping, borse di lusso, eventi esclusivi... QUALSIASI COSA ti serva — chiedi al nostro team!",
      yacht: {
