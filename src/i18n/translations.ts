...
export const translations = {
  ...
  fr: {
    ...
    services: {
      ...
      vipBannerSubtitle: "aux MEILLEURS PRIX !",
      ...
      card1Desc: "Bouteilles Magnum, étincelles et loges VIP exclusives dans les meilleurs clubs de Barcelone. La vraie expérience commence ici.",
      card2Title: "Entrées VIP + Coupe-File",
      card2Desc: "Passez directement devant la file dans les lieux les plus exclusifs de la ville. Aucune attente. Pur VIP.",
      card3Title: "Packs Multi-Jours / Pack Hebdomadaire",
      card3Desc: "Économisez en réservant des événements sur plusieurs jours au lieu de nuits individuelles. Nos packs multi-jours et hebdomadaires vous donnent accès à plusieurs soirées à un bien meilleur prix.",
      card4Title: "Pool Parties",
      card4Desc: "Fêtes de luxe dans les beach clubs de Barcelone, ambiance piscine sous le soleil méditerranéen. Magie diurne.",
      card5Title: "Réductions Restaurants",
      card5Desc: "Offres exclusives dans les meilleurs restaurants de Barcelone — paella gastronomique, steak premium et cuisine étoilée.",
      card6Title: "Appartements & Hôtels",
      card6Desc: "Appartements de luxe sélectionnés et suites d'hôtels 5 étoiles avec vue imprenable sur Barcelone.",
      card7Title: "Limousine & Chauffeur",
      card7Desc: "Arrivez avec style. Limousines noires de luxe avec chauffeurs professionnels — de l'hôtel à l'entrée du club.",
      card8Title: "Jet Ski",
      card8Desc: "Surfez sur les vagues au large de Barcelone en jet ski premium. Adrénaline, soleil et vues méditerranéennes.",
      card9Title: "Événements Privés & Thématiques",
