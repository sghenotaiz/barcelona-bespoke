...
export const translations = {
  ...
  fr: {
    ...
    services: {
      ...
      expNightlifeSubtitle: "Vivez la nuit en VIP à Barcelone",
      expNightlifeDesc: "Tables VIP avec bouteilles magnum, accès coupe-file garanti et forfaits hebdomadaires dans les meilleurs clubs — toujours aux meilleurs prix.",
      expNightlifeBullet1: "Tables exclusives dans les meilleurs clubs",
      expNightlifeBullet2: "Accès immédiat — jamais de file d'attente",
      expNightlifeBullet3: "Packs multi-nuits = réductions exclusives",
      expPoolTitle: "Pool Parties",
