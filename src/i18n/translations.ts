...
export const translations = {
  ...
  es: {
    ...
    services: {
      ...
      vipBannerSubtitle: "¡a LOS MEJORES PRECIOS!",
      ...
      card1Desc: "Botellas Magnum, bengalas y reservados VIP exclusivos en los mejores clubs de Barcelona. La verdadera experiencia comienza aquí.",
      card2Title: "Entradas VIP + Sin Cola",
      card2Desc: "Pasa directo sin hacer cola a los locales más exclusivos de la ciudad. Sin esperas. Puro VIP.",
      card3Title: "Packs Varios Días / Pack Semanal",
      card3Desc: "Ahorra más reservando eventos en varios días en lugar de noches individuales. Nuestros packs multiday y semanales te dan acceso a múltiples fiestas a un precio mucho mejor.",
      card4Title: "Pool Parties",
      card4Desc: "Fiestas de lujo en beach clubs de Barcelona, vibraciones junto a la piscina bajo el sol mediterráneo. Magia diurna.",
      card5Title: "Descuentos en Restaurantes",
      card5Desc: "Ofertas exclusivas en los mejores restaurantes de Barcelona — paella gourmet, carne premium y cocina de nivel Michelin.",
      card6Title: "Apartamentos y Hoteles",
      card6Desc: "Apartamentos de lujo seleccionados y suites de hotel 5 estrellas con impresionantes vistas al skyline de Barcelona.",
      card7Title: "Limusina y Chófer",
      card7Desc: "Llega con estilo. Limusinas negras de lujo con chóferes profesionales — del hotel a la puerta del club.",
      card8Title: "Moto de Agua",
      card8Desc: "Surca las olas de la costa de Barcelona en motos de agua premium. Adrenalina, sol y vistas mediterráneas.",
      card9Title: "Eventos Privados y Temáticos",
