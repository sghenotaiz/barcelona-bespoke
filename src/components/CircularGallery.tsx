...
import homeServicesImg from "@/assets/home-services.jpg";
import ndStickerImg from "@/assets/nd-sticker-barceloneta.png";
...
const CircularGallery = () => {
  ...
  return (
    <div id="gallery" className="relative" onTouchStart={handleTouchStart}>
      <div
        className="w-full min-h-[80vh] md:min-h-screen overflow-hidden flex items-center justify-center relative pt-2 md:pt-12"
