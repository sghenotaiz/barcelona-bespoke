...
const AboutSection = () => {
  ...
  return (
    <section id="about" className="py-24 bg-background md:py-[50px]">
      <div className="container mx-auto px-6" ref={ref}>
        ...
        >
          <img
            ...
            className="w-28 h-auto object-contain drop-shadow-2xl mb-4"
          />
          <span className="font-body text-sm text-silver tracking-wide mb-3">
            {t.about.followUs || "Follow Us on Social Media!"}
          </span>
