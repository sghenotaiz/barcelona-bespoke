...
const TeamSection = () => {
  ...
  const teamMembers = [
    ...
    {
      name: "Samuel",
      designation: t.team.samuelRole,
      quote: t.team.samuelBio,
      src: samuelImg,
      instagram: "https://www.instagram.com/_samuelgiossi_/",
      languages: ["italian" as const, "spanish" as const],
    },
    {
      name: "Giallo",
      designation: t.team.gialloRole,
      quote: t.team.gialloBio,
      src: gialloImg,
  ...
  return (
    <section id="team" className="pt-4 pb-24 bg-background md:pb-[50px] py-[10px]">
              ...
              <div
                ...
                <div
                  ...
                  className="flex-shrink-0 w-[75vw] max-w-[280px] snap-center border border-border hover:border-silver/40 transition-all duration-500 p-5 flex flex-col items-center justify-center text-center aspect-[5/4] bg-card/30">
                    ...
                    {partner.logo ? (
                       <img src={partner.logo} alt={partner.name} className="w-20 h-20 mb-4 object-contain invert brightness-200" />
                    ) : (
