...
const FloatingWhatsApp = () => {
  ...
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.95 }}
      className="fixed bottom-8 left-8 z-50 flex items-center gap-3 bg-silver px-6 py-3.5 shadow-lg font-body text-xs tracking-[0.15em] uppercase text-background hover:bg-silver-dark transition-colors duration-300"
      aria-label="WhatsApp"
    >
